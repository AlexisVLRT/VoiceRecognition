...
sample_rate, signal = wavfile.read('Datasets//Lys//enreg-05.wav')
...
axes[0].imshow(np.flipud(filter_banks_norm.T), cmap='jet', aspect='auto', extent=[0, signal_length/sample_rate, 0, sample_rate/2000])
